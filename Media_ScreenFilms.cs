...
namespace QuarterMaster.Media
{
    public static class ScreenFilms
    {
        ...
        private static extern bool GetWindowRect(IntPtr hWnd, out PointsAndRects.RECT lpRect);
        [DllImport("user32.dll")]
        private static extern bool PrintWindow(IntPtr hWnd, IntPtr hdcBlt, int nFlags);

        public static Bitmap PrintWindow(IntPtr hwnd)
        {
            GetWindowRect(hwnd, out PointsAndRects.RECT rc);
    ...
    public static class PointsAndRects
    {
