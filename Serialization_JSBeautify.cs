...
namespace QuarterMaster.Serialization
{
    ...
    public class JSBeautify
    {
        ...
        private string[] Get_next_token(ref int the_parser_pos)
        {
            var n_newlines = 0;

            if (the_parser_pos >= input.Length)
            {
                return new string[] { "", "TK_EOF" };
            }

            string c = input[the_parser_pos].ToString();
            the_parser_pos++;
            ...
            while (whitespace.Contains(c))
            {
                ...
                c = input[the_parser_pos].ToString();
                the_parser_pos++;
            }
            ...
            if (wordchar.Contains(c))
            {
                if (the_parser_pos < input.Length)
                {
                    while (wordchar.Contains(input[the_parser_pos]))
                    {
                        c += input[the_parser_pos];
                        the_parser_pos++;
                        if (the_parser_pos == input.Length)
                            break;
                    }
                ...
                if ((the_parser_pos != input.Length) && (Regex.IsMatch(c, "^[0-9]+[Ee]$")) && ((input[the_parser_pos] == '-') || (input[the_parser_pos] == '+')))
                {
                    var sign = input[the_parser_pos];
                    the_parser_pos++;

                    var t = Get_next_token(ref the_parser_pos);
                    c += sign + t[0];
            ...
            {
                var comment = "";
                if (input[the_parser_pos] == '*')
                {
                    the_parser_pos++;
                    if (the_parser_pos < input.Length)
                    {
                        while (!((input[the_parser_pos] == '*') && (input[the_parser_pos + 1] > '\0') && (input[the_parser_pos + 1] == '/') && (the_parser_pos < input.Length)))
                        {
                            comment += input[the_parser_pos];
                            the_parser_pos++;
                            if (the_parser_pos >= input.Length)
                            {
                                break;
                ...
                {
                    comment = c;
                    while ((input[the_parser_pos] != '\x0d') && (input[the_parser_pos] != '\x0a'))
                    {
                        comment += input[the_parser_pos];
                        the_parser_pos++;
                        if (the_parser_pos >= input.Length)
                ...
                )
            {
                ...
                if (the_parser_pos < input.Length)
                {
                    if (sep == "/")
                    {
                        ...
                        while (esc || in_char_class || (input[the_parser_pos].ToString() != sep))
                        {
                            resulting_string += input[the_parser_pos];
                            if (!esc)
                            {
                                esc = input[the_parser_pos] == '\\';
                                if (input[the_parser_pos] == '[')
                                {
                                    in_char_class = true;
                                }
                                else if (input[the_parser_pos] == ']')
                                {
                                    in_char_class = false;
                                }
                            }
                    ...
                    {
                        while (esc || (input[the_parser_pos].ToString() != sep))
                        {
                            resulting_string += input[the_parser_pos];
                            if (!esc)
                            {
                ...
                if (sep == "/")
                {
                    ...
                    while ((the_parser_pos < input.Length) && (wordchar.Contains(input[the_parser_pos])))
                    {
                        resulting_string += input[the_parser_pos];
                        the_parser_pos++;
                    }
            ...
            {
                var sharp = "#";
                if ((the_parser_pos < input.Length) && (digits.Contains(input[the_parser_pos])))
                {
                    do
                    {
                        c = input[the_parser_pos].ToString();
                        sharp += c;
                        the_parser_pos++;
                    } while ((the_parser_pos < input.Length) && (c != "#") && (c != "="));
                    if (c == "#")
                    {
            ...
            if ((c == "<") && (input.Substring(the_parser_pos - 1, 3) == "<!--"))
            {
                the_parser_pos += 3;
                return new string[] { "<!--", "TK_COMMENT" };
            }

            if ((c == "-") && (input.Substring(the_parser_pos - 1, 2) == "-->"))
            {
                the_parser_pos += 2;
                if (wanted_newline)
                {
            ...
            if (punct.Contains(c))
            {
                while ((the_parser_pos < input.Length) && (punct.Contains(c + input[the_parser_pos])))
                {
                    c += input[the_parser_pos];
                    the_parser_pos++;
                    if (the_parser_pos >= input.Length)
